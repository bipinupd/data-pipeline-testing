...
def run(argv=None, save_main_session=True):
    ...
    with Pipeline(options=pipeline_options) as p:
        ...
        write_to_gcs (small_words, f"{known_args.output}/small_words", label="small word")
        write_to_gcs (larger_than_average, f"{known_args.output}/larger_than_average_words", label="large words" )
