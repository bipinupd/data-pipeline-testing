...
class Divisible_By_ParDoFn_Test(unittest.TestCase):
    ...
    def test_Divisible_By_ParDoFn(self):
        ...
        with TestPipeline() as p:
            ...
            assert_that(output.not_divisible_by, equal_to(ODD_OUTPUT), label="divisble_by 2")
            assert_that(output.divisible_by, equal_to(EVEN_OUTPUT), label="not divisble_by 2")
    ...
    def test_Divisible_By_ParDoFn_For_Odd_Numbers_Only(self):
        ...
        with TestPipeline() as p:
            ...
            output = input | beam.ParDo(DivisibleByDoFn()).with_outputs(
            "divisible_by","not_divisible_by")
            assert_that(output.divisible_by, is_empty(), label="No elements in INITIAL_ARRY divisble_by 2")
